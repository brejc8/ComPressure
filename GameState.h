...
//    bool requesting_help = false;
    ...
    void render_score_2digit_err(XYPos pos, Pressure value, unsigned scale_mul, unsigned bg_colour = 9, unsigned fg_colour = 0);
    void render_number_2digit(XYPos pos, unsigned value, unsigned scale_mul, unsigned bg_colour = 9, unsigned fg_colour = 0);
    void render_number_pressure(XYPos pos, Pressure value, unsigned scale_mul, unsigned bg_colour = 9, unsigned fg_colour = 0);
    void render_number_long(XYPos pos, unsigned value, unsigned scale_mul);
    int render_number_long_get_width(unsigned value, unsigned scale_mul = 1);
    void render_number_compact(XYPos pos, int64_t value, unsigned scale_mul);
    int render_number_compact_get_width(int64_t value, unsigned scale_mul = 1);
    void render_box(XYPos pos, XYPos size, unsigned colour, int scale);
    void render_button(XYPos pos, XYPos content, unsigned colour, const char* tooltip = NULL, SDL_Texture* texture = NULL, int myscale = 0);
    void render_tooltip();
