...
void GameState::mouse_click_in_panel(unsigned clicks)
{
    ...
    } else if (panel_state == PANEL_STATE_MONITOR)
    {
        ...
        if (editing_level && (subtest_pos.y >= 0) && (subtest_pos.y < 16))
        {
            ...
            {
                const int s_steps[] = {200, 500, 625, 1000, 1250, 2000, 2500, 3333, 5000, 6667, 7500, 10000, 15000, 20000, 30000, 40000, 50000, 60000, 80000, 100000, 200000, 500000, 1000000};
